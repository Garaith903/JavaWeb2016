...
<html>
	...
	<body>
		<div>
			<p>Les catres arduino ou Raspberry sont des carte programmable
		       cela permet de faire une interface entre de la programmation et de l'électronique</p>
		    <p>Donc cela simplifie l'électronique car on ne doit plus manipubler des composants en fonction des actions que l'on veut réaliser
		...
		<div>
			...
			<p>Les fonctions:</p>
				...
				<p>Ce sont les deux fonction obligatoire sur tout programme Arduino!</p>
		</div>
		<div>
